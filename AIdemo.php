...
GOOGJI :<p id="ai"></p>         
<div id="result"></div>          
<img onclick="speakText(document.getElementById('ai').innerText);" style= "position:fixed;bottom:2%;right:2%;width:10%;height:7%;border-radius:50%;background:black;padding:10px 10px 10px 10px;" src="speaker.png">
